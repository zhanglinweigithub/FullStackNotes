...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container warning"><p class="custom-container-title">WARNING</p><p><code>readonly</code>声明的变量不能 <code>unset</code></p></div><h3 id="变量提升为全局环境变量" tabindex="-1"><a class="header-anchor" href="#变量提升为全局环境变量" aria-hidden="true">#</a> <strong>变量提升为全局环境变量</strong></h3><p><code>export</code> 变量名</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
